                                        ...
                                        <div class="single-product-wrap mb-35">
                                            <div class="product-img product-img-zoom mb-15">
                                                ...
                                                <div class="product-action-2 tooltip-style-2">
                                                    ...
                                                    <button title="Compare" value="{{$shop->id}}" class="commperstores"><i class="icon-refresh"></i></button>
                                                </div>
                                            </div>
                    ...
                    <div class="sidebar-wrapper sidebar-wrapper-mrg-right">
                        <div class="sidebar-widget mb-40">
                            ...
                            <div class="sidebar-search">
                                <form class="sidebar-search-form" id="searchshopform" enctype="multipart/form-data">
                                    @csrf
                                    <input type="search" name="searchshop" placeholder="Search here...">
                                    <button class="searchshop">
...
$(document).on('click','.searchshop',function(e){
    e.preventDefault();
    var offerfornm = new FormData($('#searchshopform')[0]);
    $.ajax({
        type:"post",
        url:"/searchshop",
...
$(document).on('click','.commperstores',function(e){
    e.preventDefault();
    var offervalue = $(this).val();
    $.ajax({
        type:"post",
        url:"/commperstore/"+offervalue,
        data:{
            '_token' : "{{csrf_token()}}",
            'id' : offervalue,
        },
